...
const Art = () => {
    return (
        <PageLayout title="art" page="/art/">
            <Title id="animation">2D animation</Title>
            ...
            <Title id="modeling">3D modeling</Title>
            ...
            <Title id="illustrations">digital illustrations</Title>
            <div class="flex flex-wrap justify-evenly gap-4 lg:gap-8 mt-10">
                <Card
                    color="bg-card-pink"
                    image={cat}
