...
import VolumeRenderer from "../components/Projects/VolumeRenderer";
import PathTracer from "../components/Projects/PathTracer";
import GPUPathTracer from "../components/Projects/GPUPathTracer";
import FaceSwap from "../components/Projects/FaceSwap";

const ComputerGraphics = () => {
    return (
        <PageLayout title="Computer Graphics" page="/computer-graphics/">
