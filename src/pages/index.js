  ...
  return (
    <div>
          ...
          <div class="pt-8 px-2 tablet-sm:px-28 min-[486px]:px-20 min-[436px]:px-16 sm:px-12 md:float-left md:absolute md:top-[16%] md:pl-20">
            ...
            <div class="mt-3 sm:mt-1 sm:float-right md:clear-both">
              <div class="m-auto block flex flex-col items-center ">
                <div>
                  <svg class="inline-block mr-1 sm:mr-2 -mt-1 scale-75 sm:scale-100" width="24" height="24" viewBox="0 0 474 379" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="top-[30rem] sm:top-[21rem] mx-10 pb-10 md:left-[500px] min-[1221px]:pr-52 md:top-[15%] absolute md:pr-8">
        ...
        {links.map(link => (
            <a href={link.url} class="bg-powder-blue rounded-md inline-block px-2.5 py-1 mr-3 my-2 text-white hover:text-white hover:scale-105 md:text-lg">{link.text}</a>
        ))}
